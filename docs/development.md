...
On build `24187685`, development-profile index construction took 1.95 seconds on the loader thread. Across 100 repeated runs, maximum full-filter latency was 7.81 ms, maximum name-search latency was 9.20 ms, and the slowest column sort scan was 7.06 ms. Interaction measurements remain below one 16.7 ms frame.
